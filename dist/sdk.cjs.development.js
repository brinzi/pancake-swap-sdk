...
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[exports.ChainId.MAINNET] = (_ChainId$MAINNET2 = {}, _ChainId$MAINNET2['0x10ED43C718714eb63d5aA57B78B54704E256024E'] = INIT_CODE_HASH, _ChainId$MAINNET2), _INIT_CODE_HASH_MAP[exports.ChainId.TESTNET] = (_ChainId$TESTNET2 = {}, _ChainId$TESTNET2['0x10ED43C718714eb63d5aA57B78B54704E256024E'] = '0xd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66', _ChainId$TESTNET2), _INIT_CODE_HASH_MAP);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, router) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : _PAIR_ADDRESS_CACHE[key]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends2 = {}, _extends2[key] = address.getCreate2Address(factory, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [token0.address, token1.address])]), initCode), _extends2));
    }
